...
class LivroService:
    ...
    def listar(self):
        ...
        try:
            ...
            for livro in livros:
                print(f'Id: {livro.id} | Título: {livro.titulo} | Resumo: {livro.resumo} | Ano: {str(livro.ano)} | Páginas: {str(livro.paginas)} | Isbn: {livro.isbn} | Codigo: {livro.codigo} | Categoria: {livro.categoria.nome} | Editora: {livro.editora.nome}  | Autor: {livro.autor.nome}')
    ...
    def mostrar_por_id(self):
        ...
        try:
            ...
            if (liv == None):
                ...
                print(f'Id: {liv.id} | Título: {liv.titulo} | Resumo: {liv.resumo} | Ano: {str(liv.ano)} | Páginas: {str(liv.paginas)} | Isbn: {liv.isbn} | Codigo: {liv.codigo} | Categoria: {liv.categoria.nome}  | Editora: {liv.editora.nome}  | Autor: {liv.autor.nome}')
        except Exception as e:
